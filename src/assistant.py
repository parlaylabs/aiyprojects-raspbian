...
class Assistant:
    ...
    def __init__(self, credentials):
        ...
        self.grpc_deadline = Assistant.DEFAULT_GRPC_DEADLINE
    ...
    def assist(self, recognized_callback):
            ...
            while continue_dialog:
                ...
                for resp in self.assistant.Converse(self._iter_converse_requests(),
                    ...
                    if resp.result.spoken_request_text:
                        ...
                        if recognized_callback(resp.result.spoken_request_text):
                          self.logger.info('Playing assistant response.')
                          if len(resp.audio_out.audio_data) > 0:
                              self.conversation_stream.write(resp.audio_out.audio_data)
                        else:
                          self.logger.info('Not playing assistant response as instructed by callback.')
                ...
                self.logger.info('Finished processing assistant response.')
